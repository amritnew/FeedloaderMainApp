...
class FeedAcceptanceTests: XCTestCase {
    ...
    private func enterBackground(with store: InMemoryFeedStore) {
        ...
        return sut.sceneWillResignActive(UIApplication.shared.connectedScenes.first!)
    }
    ...
    private class InMemoryFeedStore: FeedStore, FeedImageDataStore {
        ...
        static var withExpiredFeedCache: InMemoryFeedStore {
            return InMemoryFeedStore(feedCache: CacheFeed(feed: [], timestamp: Date.distantPast))
        }
        
        static var withNonExpiredFeedCache: InMemoryFeedStore {
            return InMemoryFeedStore(feedCache: CacheFeed(feed: [], timestamp: Date()))
        }
    }
