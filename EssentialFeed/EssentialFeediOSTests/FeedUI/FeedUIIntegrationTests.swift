...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedCompletion_disptchedFromBackgroundToMainThread() {
        let (sut, loader) = makeSUT()
        sut.loadViewIfNeeded()
        
        let exp = expectation(description: "Wait for feed loading in background queue")
    ...
    func test_loadImageDataCompletion_disptchedFromBackgroundToMainThread() {
        let (sut, loader) = makeSUT()
        sut.loadViewIfNeeded()
